class Permission < ApplicationRecord
  ...
  RESOURCES = %w[Listing Lot User Role Permission Listings::Category Offer Order DiscountCode DeliveryMethod Listings::RentalRatePlan Auction AuctionListing].freeze
