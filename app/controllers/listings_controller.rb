class ListingsController < ApplicationController
  ...
  def index
    ...
    scope = Listing.where(published: true, state: @tab).with_rich_text_description.with_attached_images.with_attached_videos.includes(lot: { listing_placeholder_attachment: :blob }).order(position: :asc, id: :asc)
