class PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    redirect_to edit_profile_path(anchor: "payment-methods"), notice: "Card ending in #{card.last_4} added."
  ...
  def set_default
    ...
    redirect_to edit_profile_path(anchor: "payment-methods"), notice: "Default card updated."
  end

  def destroy
    @service.disable_card(card_id: params[:id])
    redirect_to edit_profile_path(anchor: "payment-methods"), notice: "Card removed."
  rescue SquareCustomerService::Error => e
    redirect_to edit_profile_path(anchor: "payment-methods"), alert: e.message
  end
