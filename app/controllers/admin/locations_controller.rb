class Admin::LocationsController < Admin::BaseController
  ...
  def location_params
    params.require(:location).permit(:name, :published, :default, :logo, :ical_url, :message, :checkin_exit_url, :background_tint_opacity, :slide_timeout, :tax_rate_percent, address_attributes: [:id, :street_address, :city, :province, :postal_code, :country])
  end
end
