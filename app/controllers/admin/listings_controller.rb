class Admin::ListingsController < Admin::BaseController
  ...
  def listing_params
    base = %i[name description price acquisition_price quantity sku tax_exempt delivery_method_set_id owner_id lot_id published pricing_type show_video_as_poster]
